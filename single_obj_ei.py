...
from openmdao.lib.components.api import ParetoFilter
...
class Analysis(Assembly):
    ...
    def configure(self):
        ...
        self.connect('meta.surrogate_data.f_xy_thetas', 'ei.thetas')
        self.connect('meta.surrogate_data.f_xy_R', 'ei.R')
